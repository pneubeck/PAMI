...
public class JsonResponse {
	...
	public String toString() {
		return "JsonResponse [error=" + error + ", limit=" + limit + ", offset=" + offset + ", numberOfPageResults="
				+ numberOfPageResults + ", numberOfTotalResults=" + numberOfTotalResults + ", statusCode=" + statusCode
